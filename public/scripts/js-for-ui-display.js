...
function fashionMagazineImageDisplay() {
  $("#graphicPagesDisplayBox").html("<img src='/images/magazine-cover-300x393.jpg'/>");
...
function brochureImageDisplay() {
  $("#graphicPagesDisplayBox").html("<img src='/images/restaurant-menu-300x393.jpg'/>");
...
function collateralImageDisplay() {
  $("#graphicPagesDisplayBox").html("<img src='/images/collateral-300x393.jpg'/>");
  $("#fashionMagazineDescriptionDisplay").css("display", "none");
  $("#brochureDescriptionDisplay").css("display", "none");
...
function foodMagazineImageDisplay() {
  $("#graphicPagesDisplayBox").html("<img src='/images/food-magazine-cover-300x393.jpg'/>");
  $("#fashionMagazineDescriptionDisplay").css("display", "none");
  $("#brochureDescriptionDisplay").css("display", "none");
  $("#collateralDescriptionDisplay").css("display", "none");
...
function phoneImageDisplay() {
  $("#midColumnDisplayBox").html("<img src='/images/phone-set-540x393.jpg'/>");
  $("#phoneDescriptionDisplay").css("display", "block");
  $("#bathroomDescriptionDisplay").css("display", "none");
}
function bathroomImageDisplay() {
  $("#midColumnDisplayBox").html("<img src='/images/bathroom-digital-art-540x393.jpg'/>");
  $("#phoneDescriptionDisplay").css("display", "none");
  $("#bathroomDescriptionDisplay").css("display", "block");
}
function bathroomExtractedDisplay() {
  $("#midColumnDisplayBox").html("<img src='/images/bathroom-digital-extracted-540x393.jpg'/>");
  $("#phoneDescriptionDisplay").css("display", "none");
  $("#bathroomDescriptionDisplay").css("display", "block");
}
function bathroomLayerDisplay() {
  $("#midColumnDisplayBox").html("<img src='/images/bathroom-digital-layers-view-540x393.jpg'/>");
  $("#phoneDescriptionDisplay").css("display", "none");
  $("#bathroomDescriptionDisplay").css("display", "block");
}
function houseImageDisplay() {
  $("#bottomColumnDisplayBox").html("<img src='/images/house-digital-art-540x393.jpg'/>");
  $("#houseDescriptionDisplay").css("display", "block");
  $("#randomDescriptionDisplay").css("display", "none");
}
function houseExtractedDisplay() {
  $("#bottomColumnDisplayBox").html("<img src='/images/house-digital-layers-540x393.jpg'/>");
  $("#houseDescriptionDisplay").css("display", "block");
  $("#randomDescriptionDisplay").css("display", "none");
}
function houseLayerDisplay() {
  $("#bottomColumnDisplayBox").html("<img src='/images/house-digital-layers-view-540x393.jpg'/>");
  $("#houseDescriptionDisplay").css("display", "block");
  $("#randomDescriptionDisplay").css("display", "none");
}
function randomDrawingDisplay() {
  $("#bottomColumnDisplayBox").html("<img src='/images/random-mixed-digital-art-540x393.jpg'/>");
...
function paintingOneDisplay() {
  $("#paintingDisplayBoxTop").html("<img src='/images/painting-abandoned-boats-300x224.jpg'/>")
}
function paintingTwoDisplay() {
  $("#paintingDisplayBoxTop").html("<img src='/images/painting-fishtail-view-300x224.jpg'/>")
}
function paintingThreeDisplay() {
  $("#paintingDisplayBoxTop").html("<img src='/images/painting-crabtree-park1-300x224.jpg'/>")
}
function paintingFourDisplay() {
  $("#paintingDisplayBoxTop").html("<img src='/images/painting-peaceful-countryside-300x224.jpg'/>")
}
function paintingFiveDisplay() {
  $("#paintingDisplayBoxMid").html("<img src='/images/painting-bond-park-300x224.jpg'/>")
}
function paintingSixDisplay() {
  $("#paintingDisplayBoxMid").html("<img src='/images/painting-crabtree-park2-300x224.jpg'/>")
};

function paintingSevenDisplay() {
  $("#paintingDisplayBoxMid").html("<img src='/images/painting-plowing-300x224.jpg'/>")
}
function paintingEightDisplay() {
  $("#paintingDisplayBoxMid").html("<img src='/images/painting-mountain-group-300x224.jpg'/>")
}
function paintingNineDisplay() {
  $("#paintingDisplayBoxMid").html("<img src='/images/painting-cary-park-300x224.jpg'/>")
}
function paintingTenDisplay() {
  $("#paintingDisplayBoxMid").html("<img src='/images/painting-rupse-300x224.jpg'/>")
}
function paintingElevenDisplay() {
  $("#paintingDisplayBoxMid").html("<img src='/images/painting-stony-lake-300x224.jpg'/>")
}
function paintingTwelveDisplay() {
  $("#paintingDisplayBoxMid").html("<img src='/images/painting-sunset-lake-300x224.jpg'/>")
};

function chalkOneDisplay() {
  $("#chalkboardDisplayBox").html("<img src='/images/catering-chalkboard-300x224.jpg'/>")
}
function chalkTwoDisplay() {
  $("#chalkboardDisplayBox").html("<img src='/images/meat-chalkboard-300x224.jpg'/>")
}
function chalkThreeDisplay() {
  $("#chalkboardDisplayBox").html("<img src='/images/other-chalkboard-300x224.jpg'/>")
}
function chalkFourDisplay() {
  $("#chalkboardDisplayBox").html("<img src='/images/more-chalkboard-300x224.jpg'/>")
};